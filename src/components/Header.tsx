  ...
  return (
    <Popover>
      ...
      >
        ...
        <MobileNavLink href="/news">お知らせ</MobileNavLink>
...
export function Header() {
  return (
    <header className="sticky top-0 z-50 bg-white/95 py-6 shadow-sm backdrop-blur">
      <Container>
        <nav className="relative z-50 flex justify-between">
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            <div className="hidden md:block">
              <NavLink href="https://gekiapp.tocca.systems/auth/sign-in">ログイン</NavLink>
            </div>
            <Button href="https://gekiapp.tocca.systems/auth/sign-up" color="blue">
              <span>
                無料で始める
              </span>
            </Button>
